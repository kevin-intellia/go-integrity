...
def seed_demo_data() -> None:
    ...
    con.execute(
        f"""
        CREATE TABLE daily_campaign_insights AS
        SELECT * FROM (VALUES
            ('2026-06-01'::DATE, '2026-06-01'::DATE, '1001', 'Brand Awareness', NULL, NULL, NULL, NULL,
             12000, 240, 180, 85.50, 9800, 0.36, 7.13, 2.0, 8, 2, 0, 0, 10),
            ('2026-06-02'::DATE, '2026-06-02'::DATE, '1001', 'Brand Awareness', NULL, NULL, NULL, NULL,
             13500, 260, 195, 92.25, 10200, 0.35, 6.83, 1.93, 9, 1, 0, 0, 10),
            ('2026-06-03'::DATE, '2026-06-03'::DATE, '1002', 'Lead Gen - Form', NULL, NULL, NULL, NULL,
             8900, 310, 220, 145.00, 7200, 0.47, 16.29, 3.48, 22, 4, 0, 0, 26)
        ) AS t({INSIGHTS_DDL})
        """
    )
    con.execute(
        f"""
        CREATE TABLE daily_adset_insights AS
        SELECT * FROM (VALUES
            ('2026-06-01'::DATE, '2026-06-01'::DATE, '1001', 'Brand Awareness', '2001', 'Broad - US', NULL, NULL,
             7000, 140, 105, 48.00, 5600, 0.34, 6.86, 2.0, 5, 1, 0, 0, 6),
            ('2026-06-01'::DATE, '2026-06-01'::DATE, '1001', 'Brand Awareness', '2002', 'Retarget - US', NULL, NULL,
             5000, 100, 75, 37.50, 4200, 0.38, 7.50, 2.0, 3, 1, 0, 0, 4),
            ('2026-06-02'::DATE, '2026-06-02'::DATE, '1002', 'Lead Gen - Form', '2003', 'Lookalike 1%', NULL, NULL,
             9100, 295, 210, 138.75, 7400, 0.47, 15.25, 3.24, 19, 3, 0, 0, 22)
        ) AS t({INSIGHTS_DDL})
        """
    )
    con.close()
